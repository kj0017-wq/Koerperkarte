const fs = require('fs');
const csvPath = 'C:\\Users\\kj\\.codex\\codex-remote-attachments\\01a0004f-cde6-76b2-b25a-95e97b3e6b24\\1380A8BE-D13D-42E0-B1E7-4FEEA438FF2D\\1-body-map-blocks.csv';
...
const out = 'output/import/body-map-blocks-latest.json';
fs.writeFileSync(out, JSON.stringify(blocks, null, 2), 'utf8');
console.log(JSON.stringify({ out, blocks: Object.keys(blocks).length }, null, 2));
